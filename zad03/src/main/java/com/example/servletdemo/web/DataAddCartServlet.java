...
public class DataAddCartServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Wardrobe> wardrobes = ss.getAllWardrobes();
		Wardrobe wardrobeToCart = wardrobes.get(Integer.parseInt(request.getParameter("add")) - 1);

		ss.addToShoppingCart(wardrobeToCart);
